...
graph LR
    subgraph Tabla Comparativa
        A[Característica] --> B[Competidor A]
        A --> C[Competidor B]
        B --> D[Precio: Muy competitivo]
        C --> E[Precio: Alto]
        B --> F[Normativa ISO: RFNBO ISO 14687 ISO 19880-8]
        C --> G[Normativa ISO: RFNBO ISO 14687]
        B --> H[Medición en Tiempo Real: Sí]
        C --> I[Medición en Tiempo Real: Sí]
        B --> J[Trazabilidad Digital: Huella H2]
        C --> K[Trazabilidad Digital: Pasaporte Digital]
        B --> L[Interfaz de Usuario: Intuitiva]
        C --> M[Interfaz de Usuario: Media]
        B --> N[Requerimiento de Infraestructura: Muy bajo]
        C --> O[Requerimiento de Infraestructura: Medio]
        B --> P[Automatización del Proceso: Certificado Loghid]
        C --> Q[Automatización del Proceso: Automatización RFNBO]
        B --> R[Seguridad y Protección de Datos: Alta Cifrado AES-256]
        C --> S[Seguridad y Protección de Datos: Alta]
        B --> T[Conformidad con Regulaciones UE: RFNBO]
        C --> U[Conformidad con Regulaciones UE: RFNBO]
        B --> V[Facilidad de Integración: Alta API REST]
        C --> W[Facilidad de Integración: Media]
        B --> X[Soporte y Actualizaciones: Continuo]
        C --> Y[Soporte y Actualizaciones: Con Atmen]
        B --> Z[Movilidad: Nacional]
        C --> AA[Movilidad: Regional]
        B --> AB[Código Abierto: Open Source]
        C --> AC[Código Abierto: No]
        B --> AD[Modelo de Negocio: Sin ánimo de lucro]
