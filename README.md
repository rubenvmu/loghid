...
graph TD;
    ...
    D --> D1[Bureau Veritas - Bilbao]
    D --> D2[TÜV SÜD - Laboratorio de hidrógeno]
    D --> D3[Tecnalia - Análisis de hidrógeno]
    D --> D4[CNH2 - Puertollano]
    D --> D5[Fundación Hidrógeno Aragón - Investigación y desarrollo]
    D --> D6[INMA - Servicio de Análisis Elemental]
...
```mermaid
graph TD;
    A[Transporte de H₂ en tanques] --> B[Riesgo de degradación]
    B --> C[Factores: impurezas, presión, temperatura]
    C --> D[Alteración de la composición]
