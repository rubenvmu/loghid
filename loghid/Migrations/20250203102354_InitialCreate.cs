        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PemResult = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    IsoThreshold = table.Column<double>(type: "REAL", nullable: false),
                    PemResultMin = table.Column<double>(type: "REAL", nullable: false),
                    PemResultMax = table.Column<double>(type: "REAL", nullable: false),
                    Probability = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    IsoThreshold = table.Column<double>(type: "REAL", nullable: false),
                    PemResultC2 = table.Column<double>(type: "REAL", nullable: false),
                    PemResultC3 = table.Column<double>(type: "REAL", nullable: false),
                    PemResultC4 = table.Column<double>(type: "REAL", nullable: false),
                    PemResultC5 = table.Column<double>(type: "REAL", nullable: false),
                    PemResultC6C18 = table.Column<double>(type: "REAL", nullable: false),
                    Probability = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
